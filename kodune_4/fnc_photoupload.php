...
function addPhotoData2DB($fileName, $alt, $privacy)
{
  ...
  if ($stmt->execute()) {
    //echo "Failinimi, tekst ja privaatsus salvestatud andmebaasi!";
  } else {
    echo "Andmebaasi salvestamisel tekkis tehniline tõrge: " . $stmt->error;
  }
