...
class __TwigTemplate_b0a417baf209ad332f2a0d96ad4a76254f26d6b8540b1198acb725dce8a1bda4 extends Template
{
    ...
    href=\"";
        // line 2
        echo twig_escape_filter($this->env, ((($context["parentDir"] ?? null)) ? (call_user_func_array($this->env->getFunction('parent_dir')->getCallable(), [($context["path"] ?? null)])) : (call_user_func_array($this->env->getFunction('url')->getCallable(), [twig_get_attribute($this->env, $this->source, ($context["file"] ?? null), "getPathname", [], "any", false, false, false, 2)]))), "html", null, true);
        echo "\"
...
>
    <div class=\"flex justify-between items-center p-4 w-full\">
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["file"] ?? null), "isFile", [], "any", false, false, false, 18)) {
            ...
            // line 23
            echo twig_escape_filter($this->env, twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["file"] ?? null), "getPathname", [], "any", false, false, false, 23), "js"), "html", null, true);
            echo "')\"
                >
        ...
        if ((($context["parentDir"] ?? null) || twig_get_attribute($this->env, $this->source, ($context["file"] ?? null), "isDir", [], "any", false, false, false, 31))) {
            ...
            // line 34
            echo "                ";
            echo twig_escape_filter($this->env, call_user_func_array($this->env->getFunction('sizeForHumans')->getCallable(), [($context["file"] ?? null)]), "html", null, true);
            echo "
            ";
        }
        // line 36
...
";
    ...
    {
        return new Source("", "components/file.twig", "C:\\Drive\\Kool\\RIF17 II kursus\\II semester\\Veebirakendused ja nende loomine (PHP) (HKI5007.HK)\\Veebirakendused-ja-nende-loomine-PHP-HKI5007.HK-\\app\\views\\components\\file.twig");
    }
}
